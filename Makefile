...
SRC = main.c \
	  ...
	  $(SRC_DIR)/utils/fonctions/ft_strlen.c $(SRC_DIR)/utils/fonctions/ft_strjoin.c $(SRC_DIR)/utils/fonctions/ft_memcpy.c $(SRC_DIR)/utils/fonctions/redirection.c $(SRC_DIR)/utils/fonctions/ft_itoa.c $(SRC_DIR)/utils/fonctions/is_input_empty.c\
